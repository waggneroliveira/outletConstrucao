                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formCategoria" action="{{ route('admin.blog.update', ['blog' => $blog->id]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="publishing" data-mask="00/00/0000" name="publishing" class="form-control" required value="{{$blog->publishing}}">
                                        </div>
                                        <div class="form-group mb-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="text" id="product-description" rows="5">{{$blog->text}}</textarea>
                                        </div>
                                        <input type="file" class="dropify" name="path_image" data-default-file="{{ url('storage/admin/uploads/fotos') }}/{{ $blog->path_image }}" data-height="200" />
                                    </div><!-- end col -->
                                </div>
                                <!-- end row -->
                            </form>
