                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="formCategoria" action="{{ route('admin.subcategory.update', ['subcategory' => $subcategory['slug']]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" name="category_id" required id="example-select">
                                                ...
                                                @foreach($categories as $category)
                                                    <option {{ ($category['id'] == $subcategory['category_id'] ? 'selected' : '') }} value="{{ $category['id'] }}">{{ $category['title'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group mb-3">
                                            <div class="custom-control custom-checkbox form-check">
                                                <input type="checkbox" {{ ($subcategory['active'] == 1 ? 'checked' : '') }} name="active" value="1" class="custom-control-input" id="active">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="simpleinput" required name="title" value="{{ $subcategory['title'] }}" class="form-control">
                                        </div>
