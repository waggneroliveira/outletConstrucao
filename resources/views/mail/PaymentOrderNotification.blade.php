                    ...
                    <td colspan="2" style="text-align: center;border-bottom: 1px solid rgb(231, 231, 231);">
                        ...
                        <div style="margin-top: 10px;padding-bottom: 15px;">
                            ...
                            <p style="font-weight: normal;font-size: 14px;">
                                O seu pedido está sendo processado. <br>
                                Você receberá um e-mail informando mais detalhes sobre status de pagamento<br>
                                Para mais informações sobre o seu pedido visite sua área do cliente <a href="{{route('customer.home')}}" style="color: blue;" target="_blank" rel="noopener noreferrer">clicando aqui.</a>
                            </p>
                        </div>
                    </td>
                </tr>
