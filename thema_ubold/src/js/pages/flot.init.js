...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var colors = ['#4fc6e1','#7e57c2','#e3eaef','#7bdcf2',"#9872d9"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#4fc6e1']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#4fc6e1','#7e57c2','#e3eaef','#7bdcf2',"#9872d9"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#7e57c2','#4fc6e1','#e3eaef'], ds);
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ['#4fc6e1','#7e57c2'], line_data);
	},
